...
public abstract class PanesActivity extends ActionBarActivity implements FragmentLauncher {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (mDelegate.onOptionsItemSelected(item))
            return true;
    ...
    /* *********************************************************************
     * Adding, removing, getting fragments Note: fragments are added in a stack.
     * Here's a sample use case: setMenuFragment(A) stack: A addFragment(A, B)
     * stack: A, B addFragment(B, C) stack: A, B, C addFragment(B, D) stack: A,
     * B, D clearFragments() stack: A
     * *********************************************************************
     */
     ...
     * Get menu framgent
     */
    public android.support.v4.app.Fragment getMenuFragment() {
