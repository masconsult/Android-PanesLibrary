...
public class TabletDelegate extends ActivityDelegate implements PanesLayout.OnIndexChangedListener {
    ...
    /**
     * Save the fragment stack manually. The reason to do this is because
     * sometimes when we need to retrieve a fragment, that fragment has not yet
     * been added.
     */
